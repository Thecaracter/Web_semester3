            ...
            <form role="form" action="proses.php" method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" value="<?php echo $hasilkode ?>" class="form-control" name="id_pinjaman" rows="3"
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="nama_pinjaman" onchange="inTEXTbox(this.value)">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ?>
                      ??
                      <option value="<?php echo $row['nama_pinjaman']; ?>" <?php
                         if (isset($_GET['reqpin']) && $_GET['reqpin'] == 'edit') {
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1"
                    aria-hidden="false" name="id_anggota">
                    <option selected="selected" value="">-Pilih-</option>
                    <?php
                    ...
                    while ($r = mysqli_fetch_array($sql)) {
                      ?>
                      <option value="<?php echo $r['id_anggota'] ?>" <?php
                         if (isset($_GET['reqpin']) && $_GET['reqpin'] == 'edit') {
                ...
                <div class="form-group">
                  ...
                  <input type="number" value="<?php echo $besar_pinjaman ?>" class="form-control" name="besar_pinjaman"
                    rows="3" placeholder="Contoh 1000000">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tgl_pengajuan_pinjaman"
                    value="<?php echo $tgl_pengajuan_pinjaman ?>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask="">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tgl_acc_peminjam"
                    value="<?php echo $tgl_acc_pinjaman ?>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask="">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tgl_pinjaman" value="<?php echo $tgl_pinjaman ?>"
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="MicampoTXTO" name="tgl_pelunasan"
                    value="<?php echo $tgl_pelunasan ?>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask="">
                </div>
              </div>
              <!-- /.box-body -->
