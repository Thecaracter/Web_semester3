    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          <table id="dataTable" class="table table-bordered table-striped table-responsive" data-toggle="table">
            <thead>
              <tr class="info">
                <th>
                  <center>No</center>
            ...
            <tbody>
              <tr>
                ...
                while ($data = mysqli_fetch_array($sql)) {
                  ...
                  <td>
                    <?php echo $data['tmp_lahir'] . ' ' . TanggalIndo($data['tgl_lahir']) ?>
                  </td>
                  <td>
                    <center>
                  ...
                  <td>
                    <center>
                      ...
                      <a href="page-detail-anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>" title="Lihat Detail"
                      ...
                      <a href="proses.php?id_anggota=<?php echo $data['id_anggota']; ?>&reqa=dell"
                        title="Berhenti Jadi Anggota" class="btn btn-danger btn-sm alert_notif"><span class="fa fa-times">
                          Berhenti</span>
                      </a>
                    </center>
                  </td>
