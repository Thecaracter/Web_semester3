      ...
      <div class="box-body">
        <form role="form" action="page-cetak-simpanan.php" method="GET">
          <div class="input-group">
            <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1"
              aria-hidden="false" name="bln" id="id_pinjaman">
        ...
        if (isset($_GET['bln'])) {
          ...
          if ($jum > 0) {
                ...
                <tbody>
                  <tr>
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                      ...
                      <td>
                        <center><?php echo TanggalIndo($data['tgl_simpanan']) ?></center>
                      </td>
                      <td>
                        <center>
                      ...
                      <td>
                        <center><a
                            href="cetak-simpanan.php?id_anggota=<?php echo $data['id_anggota']; ?>&bln=<?php echo $data['bln']; ?>"
                            title="Edit Data ini" class="btn btn-info btn-sm"><i class="fa fa-print "></i> Print</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
            ...
            <a href="cetak-simpanan-keseluruhan.php?bln=<?php echo $_GET['bln'] ?>" class="btn btn-primary pull-right"
