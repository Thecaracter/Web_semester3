                ...
                <tbody>
                  <tr>
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                      ...
                      <td>
                        <center>
                          <a href="proses.php?id_angsuran=<?php echo $data['id_angsuran']; ?>&reqang=dell"
                            title="Hapus Data ini" class="btn btn-danger btn-sm alert_notif"><span
                              class="glyphicon glyphicon-trash"> Hapus</span> </a>
