	...
	<section class="content">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">
					<?php echo $namaform; ?> Data Angsuran
				</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				...
				<form role="form" action="proses.php" method="POST">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<input type="text" value="<?php echo $hasilkode ?>" class="form-control" name="id_angsuran"
						...
						<div class="form-group">
							...
							<select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
								tabindex="-1" aria-hidden="false" name="id_pinjaman" id="id_pinjaman">
								...
								while ($r = mysqli_fetch_array($sql)) {
									...
									<option id_anggota="<?php echo $r['id_anggota'] ?>" besar_angsuran="<?php
									   ...
									   ?>" nama_simpanan="<?php echo $r['nama_pinjaman'] ?>" angsuran_ke="<?php
										  ...
										  ?>" tgl_pembayaran="<?php echo $tgl_pembayaran = date('Y-m-d'); ?>" value="<?php echo $r['id_pinjaman'] ?>" <?php
						...
						<div class="form-group">
							...
							<input type="text" id="nama_simpanan" value="<?php echo $nama_pinjaman ?>"
								class="form-control" name="nama_pinjaman" rows="3" placeholder="Nama Pinjaman">
						</div>
						<div class="form-group">
							<label>ID Anggota</label>
							<input type="text" id="id_anggota" value="<?php echo $id_anggota ?>" class="form-control"
								name="id_anggota" rows="3" placeholder="ID Anggota">
						</div>
						...
						<div class="form-group">
							...
							<input type="number" value="<?php echo $angsuran_ke ?>"
								id="<?php if (isset($_GET['reqang']) && $_GET['reqang'] == 'add') { ?>angsuran_ke<?php } ?>"
								class="form-control" name="angsuran_ke" rows="3" placeholder="Angsuran Ke">
						</div>
