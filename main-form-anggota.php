					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputPassword1" value="Simpanan Pokok"
								placeholder=" Simpanan Wajib" name="nm_simpanan">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Besar Simpanan</label>
							<input type="number" class="form-control" id="exampleInputPassword1" value="50000"
								placeholder="Besar Simpanan" name="besar_simpanan">
						</div>
